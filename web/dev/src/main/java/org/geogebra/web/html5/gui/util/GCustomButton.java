...
public abstract class GCustomButton extends ButtonBase {
	 ...
	 */
	private static final int DOWN_HOVERING = DOWN_ATTRIBUTE
			| HOVERING_ATTRIBUTE;
	...
	public final Face getDownDisabledFace() {
		if (downDisabled == null) {
			setDownDisabledFace(
					createFace(getDownFace(), "down-disabled", DOWN_DISABLED));
		}
		return downDisabled;
	}
	...
	public final Face getDownHoveringFace() {
		if (downHovering == null) {
			setDownHoveringFace(
					createFace(getDownFace(), "down-hovering", DOWN_HOVERING));
		}
		return downHovering;
	}
	...
	public final Face getUpDisabledFace() {
		if (upDisabled == null) {
			setUpDisabledFace(
					createFace(getUpFace(), "up-disabled", UP_DISABLED));
		}
		return upDisabled;
	}
	...
	public final Face getUpHoveringFace() {
		if (upHovering == null) {
			setUpHoveringFace(
					createFace(getUpFace(), "up-hovering", UP_HOVERING));
		}
		return upHovering;
	}
	...
	private Face createFace(Face delegateTo, final String name,
			final int faceID) {
